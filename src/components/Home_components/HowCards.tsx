    ...
    <div className="bg-black w-full md:h-[460px] flex  items-center justify-center py-14">
       <div className="flex flex-col md:flex-row items-center justify-center gap-[55px] px-5">
          <div className="w-full md:w-[360px] h-[335px] bg-[#fff] rounded-2xl p-6">
            <img src="../../../public/assets/icons/submit_icon.png" alt="" />
            ...
            <img src="../../../public/assets/icons/Line 17.png" alt="" className="mx-auto pt-9"/>
          </div>

          <div className="w-full md:w-[360px] h-[335px] bg-[#fff] rounded-2xl p-6">
            <img src="../../../public/assets/icons/payment.png" alt="" />
            ...
            <img src="../../../public/assets/icons/Line 17.png" alt="" className="mx-auto pt-12"/>
          </div>

          <div className="w-full md:w-[360px] h-[335px] bg-[#fff] rounded-2xl p-6">
            <img src="../../../public/assets/icons/review.png" alt="" />
            ...
            <img src="../../../public/assets/icons/Line 17.png" alt="" className="mx-auto pt-14"/>
          </div>
        </div>
    </div>
  )
